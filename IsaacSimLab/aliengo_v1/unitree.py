...
* :obj:`UNITREE_AlienGo_CFG`: Unitree AlienGo robot with DC motor model for the legs
...
# TAKEN FROM ANYMA ASSETS, JUST AS EXAMPLE
...
mANYMAL_C_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        #usd_path=f"{ISAACLAB_NUCLEUS_DIR}/Robots/ANYbotics/ANYmal-C/anymal_c.usd",  #correct one
        # usd_path=f"{ISAAC_NUCLEUS_DIR}/Robots/ANYbotics/anymal_instanceable.usd",
        usd_path="/home/rl_sim/RL_Dog/assets/USD/aliengo_black.usd",
