...
This script demonstrates the environment for a quadruped robot AlienGo.
    ...
    cd
    cd IsaacLab_
    ./isaaclab.sh -p /home/rl_sim/RL_Dog/IsaacSimLab/aliengo_vP/aliengo_rsl_simulate.py --num_envs 1

    #IF HEADLESS:
    ./isaaclab.sh -p /home/rl_sim/RL_Dog/IsaacSimLab/aliengo_vP/aliengo_rsl_simulate.py --num_envs 1 --headless --enable_cameras
...
from aliengo_agent_cfg import aliengo_agent_cfg
...
def main():
    ...
    agent_cfg: RslRlOnPolicyRunnerCfg = aliengo_agent_cfg
